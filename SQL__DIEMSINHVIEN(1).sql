...
insert into SinhVien values('0241060218',N'Ngô Công Một',1,'08/27/1999',N'Hải Dương','CN04')
insert into SinhVien values('0241060318',N'Ngô Công Hai',1,'2/08/1999',N'Nam Định','CN04')
insert into SinhVien values('0241060818',N'Ngô Công Ba',1,'7/08/1999',N'Hà Nội','CN01')
...
insert into Diem(MaSV,MaMH,HocKy,DiemLan1) values('0241060318','Mang',5,8)
  ...
  --12. CAC THAO TAC DU LIEU VOI CAC BANG
	...
	GO
          --TEST
              sp_insSINHVIEN '0241061298',N'Sơn Tùng MTP ',1,'5/5/1997',N'Thái Bình','CN01'
              SELECT * FROM SINHVIEN
GO
  --B. XOA DU LIEU
	  ...
	  GO
         ...
         --- KIEM TRA
		 GO
         sp_updateSINHVIEN '0241060218','BANG KIEU',1,'5/5/1997','HA NOI','CN03'
         select * from SINHVIEN
	 ...
	 GO
         ...
         END
          ...
          --TEST
        GO
           sp_insLOP 'CN05','D18CQCN05','CNTT','ÐHCQ','D18'
           select * from lop
		GO
		--B. XOA DU LIEU
